...
public class CoolTemperateBiomes {
    ...
    public static Biome PolarDesert() {
        ...
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).surfaceBuilder(SurvivalismConfiguredSurfaceBuilders.CSB_COOL_TEMPERATE);
