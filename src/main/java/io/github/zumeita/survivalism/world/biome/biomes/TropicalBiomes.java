...
public class TropicalBiomes {
    ...
    public static Biome PolarDesert() {
        ...
        BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).surfaceBuilder(SurvivalismConfiguredSurfaceBuilders.CSB_TROPICAL);
