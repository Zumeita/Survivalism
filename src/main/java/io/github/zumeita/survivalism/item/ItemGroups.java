...
public class ItemGroups extends ItemGroup {
    ...
    public static final ItemGroup ITEM_GROUP_SEEDS = new ItemGroups("seeds", () -> new ItemStack(ItemVars.sagebrush));
    public static final ItemGroup ITEM_GROUP_FOOD = new ItemGroups("food", () -> new ItemStack(ItemVars.sagebrush));
    public static final ItemGroup ITEM_GROUP_VEGETATION = new ItemGroups("vegetation", () -> new ItemStack(ItemVars.sagebrush));
